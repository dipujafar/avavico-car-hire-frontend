...
const ProfileInfo = ({editLink}: {editLink: string}) => {
  ...
  return (
    ...
    >
      <h4 className="w-fit ml-auto mb-2 underline text-primary-cyan hover:text-cyan-600">
        <Link href={editLink} className=" text-end w-full ">
          Edit Profile
        </Link>
      </h4>
      <div className=" flex flex-col lg:flex-row   gap-x-5">
        <Avatar className="xl:size-60 md:size-52 size-32 mx-auto mb-5 lg:mb-0">
          <AvatarImage src={userData?.data?.photo?.[0]} className="object-cover"/>
...
<div className="grid md:grid-cols-2 gap-2">
          <div className="bg-[#F8F9FA] px-2.5 xl:py-2 py-1 rounded border border-[#E6E6E6] md:text-lg text-black flex flex-wrap items-center gap-x-2 w-full">
