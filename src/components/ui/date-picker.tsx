...
const DateTimePicker = React.forwardRef<Partial<DateTimePickerRef>, DateTimePickerProps>(
  (
    ...
    return (
      <Popover>
        <PopoverTrigger className="border-none shadow-none" asChild disabled={disabled}>
          <Button
            variant="outline"
            className={cn("w-full justify-start text-left font-normal p-0 px-0 mr-0 m-0", className)}
            ref={buttonRef}
          >
