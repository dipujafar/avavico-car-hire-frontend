...
const StaticSection = () => {
  return (
    <div className="bg-[url('/static_section_bg.png')]  bg-cover origin-center py-20">
      <Container className="flex justify-between gap-x-10 text-white">
      ...
      <Container className="xl:mt-24 md:mt-20 mt-16 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 gap-8 text-white">
