    ...
    <div>
      <Container className="flex flex-col xl:flex-row justify-between gap-x-10 gap-y-2 text-[#333]">
        <div className="flex-1">
          <motion.h1
            ...
            viewport={{ once: true }}
            className=" lg:text-[32px] text-xl font-bold max-w-2xl"
          >
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="flex-1 font-medium lg:text-lg text-[#545454]"
        >
      ...
      <Container>
        ...
        // @ts-ignore
          ...
          whileInView="animate"
          viewport={{ once: true }}
          className="mt-12 grid grid-cols-1 md:grid-cols-2 xl:grid-cols-4 xl:gap-8 gap-4 text-[#8A8A8A]"
        >
          {staticSectionData.map((item) => (
            ...
            >
              {isLoading ? (
                <Skeleton className="h-7 bg-gray-300 w-full mb-2.5" />
              ) : (
